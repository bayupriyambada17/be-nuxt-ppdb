...
export default {
  ...
  data() {
   ...
   computed: {
        ...
        kepemilikanKendaraan() {
            return this.$store.state.operator.kepemilikanKendaraan.kepemilikanKendaraan
        },
    },
  ...
  methods: {
    ...
    async storeData() {
      ...
      await this.$store.dispatch('operator/kepemilikanKendaraan/storeDataState', formData)
