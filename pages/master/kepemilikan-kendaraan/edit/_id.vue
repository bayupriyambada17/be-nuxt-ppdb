...
export default {
  ...
  async asyncData({ store, route }) {
    await store.dispatch(
      "operator/kepemilikanKendaraan/getDetailIdstate",
      route.params.id
    );
  },
  ...
  mounted() {
    this.data.status =
      this.$store.state.operator.kepemilikanKendaraan.kepemilikanKendaraan.status;
  },
  ...
  methods: {
    ...
    async updateData() {
      ...
      await this.$store
        .dispatch("operator/kepemilikanKendaraan/updateDataState", {
