...
export default {
  ...
  async asyncData({ store, route }) {
    await store.dispatch(
      "operator/keadaanOrangTua/getDetailIdstate",
      route.params.id
    );
  },
  ...
  mounted() {
    this.data.status =
      this.$store.state.operator.keadaanOrangTua.keadaanOrangTua.status;
  },
  ...
  methods: {
    ...
    async updateData() {
      ...
      await this.$store
        .dispatch("operator/keadaanOrangTua/updateDataState", {
