...
export default {
  ...
  async asyncData({ store, route }) {
    await store.dispatch(
      "operator/mandiCuciKakus/getDetailIdstate",
      route.params.id
    );
  },
  ...
  mounted() {
    this.data.status =
      this.$store.state.operator.mandiCuciKakus.mandiCuciKakus.status;
  },
  ...
  methods: {
    ...
    async updateData() {
      ...
      await this.$store
        .dispatch("operator/mandiCuciKakus/updateDataState", {
