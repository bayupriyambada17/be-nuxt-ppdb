            ...
            <div class="card border-0 rounded shadow-sm border-top-orange">
              ...
              <div class="card-body">
                <div class="form-group">
                  <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <nuxt-link
                        :to="{ name: 'status-harta-tidak-bergerak-create' }"
                ...
                <b-table
                  ...
                  bordered
                  hover
                  :items="statusHartaTidakBergerak"
                  :fields="fields"
                  show-empty
                >
...
export default {
  ...
  data() {
    return {
      ...
      search: "",
      dataTitle: "Status Harta Tidak Bergerak",
    };
  },
  ...
  //computed
  computed: {
    statusHartaTidakBergerak() {
      const statusHartaTidakBergerakData = this.$store.state.operator.statusHartaTidakBergerak.statusHartaTidakBergerak;

      // Pastikan statusHartaTidakBergerakData adalah array sebelum menghitung indeks
      if (Array.isArray(statusHartaTidakBergerakData)) {
        return statusHartaTidakBergerakData;
      } else {
        return [];
      }
    },
  ...
  methods: {
    ...
    searchData() {
      this.$store.commit("operator/statusHartaTidakBergerak/SET_PAGE", 1);
      this.$store.dispatch(
        "operator/statusHartaTidakBergerak/getAllDataState",
        this.search
      );
    },
      ...
      if (confirmationResult.isConfirmed) {
        try {
          const response = await this.$axios.delete(
            `/api/v1/status-harta-tidak-bergerak/${item.id}/hapus`
          );
