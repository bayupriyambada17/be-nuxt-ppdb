...
export const mutations = {
  ...
  SET_FUNCTION_DATA(state, payload) {
    ...
    state.statusKepemilikanKendaraan = payload
  },
...
export const actions = {
  ...
  getAllDataState({ commit, state }, payload) {
    ...
    return new Promise((resolve, reject) => {
      ...
      this.$axios.get(`/api/v1/status-kepemilikan-kendaraan?status=${search}&page=${state.page}`)
  ...
  storeDataState({ dispatch, commit }, payload) {
    ...
    //set promise
    return new Promise((resolve, reject) => {
      this.$axios.post('/api/v1/status-kepemilikan-kendaraan/tambah', payload)
  ...
  getDetailIdstate({ commit }, payload) {
    ...
    return new Promise((resolve, reject) => {
      ...
      this.$axios.get(`/api/v1/status-kepemilikan-kendaraan/${payload}`)
  ...
  updateDataState({ dispatch, commit }, { dataId, payload }) {
    ...
    return new Promise((resolve, reject) => {
      ...
      this.$axios.post(`/api/v1/status-kepemilikan-kendaraan/${dataId}/ubah`, payload)
