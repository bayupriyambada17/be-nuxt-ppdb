...
export const mutations = {
  ...
  SET_FUNCTION_DATA(state, payload) {
    ...
    state.penerimaBantuanSosial = payload
  },
...
export const actions = {
  ...
  getAllDataState({ commit, state }, payload) {
    ...
    return new Promise((resolve, reject) => {
      ...
      this.$axios.get(`/api/v1/penerimaan-bantuan-sosial?status=${search}&page=${state.page}`)
  ...
  storeDataState({ dispatch, commit }, payload) {
    ...
    //set promise
    return new Promise((resolve, reject) => {
      this.$axios.post('/api/v1/penerimaan-bantuan-sosial/tambah', payload)
  ...
  getDetailIdstate({ commit }, payload) {
    ...
    return new Promise((resolve, reject) => {
      ...
      this.$axios.get(`/api/v1/penerimaan-bantuan-sosial/${payload}`)
  ...
  updateDataState({ dispatch, commit }, { dataId, payload }) {
    ...
    return new Promise((resolve, reject) => {
      ...
      this.$axios.post(`/api/v1/penerimaan-bantuan-sosial/${dataId}/ubah`, payload)
