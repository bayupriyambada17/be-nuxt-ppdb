...
export const mutations = {
  ...
  SET_FUNCTION_DATA(state, payload) {
    ...
    state.statusKepemilikanRumah = payload
  },
...
export const actions = {
  ...
  getAllDataState({ commit, state }, payload) {
    ...
    return new Promise((resolve, reject) => {
      ...
      this.$axios.get(`/api/v1/status-kepemilikan-rumah?status=${search}&page=${state.page}`)
  ...
  storeDataState({ dispatch, commit }, payload) {
    ...
    //set promise
    return new Promise((resolve, reject) => {
      this.$axios.post('/api/v1/status-kepemilikan-rumah/tambah', payload)
  ...
  getDetailIdstate({ commit }, payload) {
    ...
    return new Promise((resolve, reject) => {
      ...
      this.$axios.get(`/api/v1/status-kepemilikan-rumah/${payload}`)
  ...
  updateDataState({ dispatch, commit }, { dataId, payload }) {
    ...
    return new Promise((resolve, reject) => {
      ...
      this.$axios.post(`/api/v1/status-kepemilikan-rumah/${dataId}/ubah`, payload)
